...
import (
	...
	"github.com/DAO-Metaplayer/metachain/command/genesis/predeploy"
...
func setFlags(cmd *cobra.Command) {
	...
	// {
	// 	cmd.Flags().StringVar(
	// 		&params.rawMETABFTValidatorType,
	// 		command.METABFTValidatorTypeFlag,
	// 		string(validators.BLSValidatorType),
	// 		"the type of validators in METABFT",
	// 	)

	// 	cmd.Flags().StringVar(
	// 		&params.validatorPrefixPath,
	// 		command.METABFTValidatorPrefixFlag,
	// 		"",
	// 		"prefix path for validator folder directory. "+
	// 			"Needs to be present if metabft-validator is omitted",
	// 	)

	// 	cmd.Flags().StringArrayVar(
	// 		&params.metabftValidatorsRaw,
	// 		command.METABFTValidatorFlag,
	// 		[]string{},
	// 		"addresses to be used as METABFT validators, can be used multiple times. "+
	// 			"Needs to be present if metabft-validators-prefix-path is omitted",
	// 	)

	// 	// --metabft-validator-prefix-path & --metabft-validator can't be given at same time
	// 	cmd.MarkFlagsMutuallyExclusive(command.METABFTValidatorPrefixFlag, command.METABFTValidatorFlag)
	// }
	...
	// 		posFlag,
	// 		false,
	// 		"the flag indicating that the client should use Proof of Stake METABFT. Defaults to "+
	...
	// mbft
	{
		cmd.Flags().StringVar(
			...
			validatorsPathFlag,
			"./",
			"root path containing mbft validators secrets",
		)
		...
		cmd.Flags().StringVar(
			...
			"folder prefix names for mbft validators secrets",
		)
...
func runCommand(cmd *cobra.Command, _ []string) {
	...
	if params.isMBFTConsensus() {
		err = params.generateMBftChainConfig(outputter)
	} else {
