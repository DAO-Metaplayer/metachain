...
import (
	...
	"github.com/DAO-Metaplayer/metachain/secrets/helper"
...
func parseBurnContractInfo(burnContractInfoRaw string) (*mbft.BurnContractInfo, error) {
...
// GenerateExtraDatambft populates Extra with specific fields required for mbft consensus protocol
func GenerateExtraDataMBft(validators []*validator.ValidatorMetadata) ([]byte, error) {
	delta := &validator.ValidatorSetDelta{
		Added:   validators,
		Removed: bitmap.Bitmap{},
	}

	extra := mbft.Extra{Validators: delta, Checkpoint: &mbft.CheckpointData{}}
