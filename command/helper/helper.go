...
import (
	...
	// metabftOp "github.com/DAO-Metaplayer/metachain/consensus/metabft/proto"
	...
	txpoolOp "github.com/DAO-Metaplayer/metachain/txpool/proto"
...
// // GetMETABFTOperatorClientConnection returns the METABFT operator client connection
// func GetMETABFTOperatorClientConnection(address string) (
// 	metabftOp.metabftOperatorClient,
// 	error,
// ) {
// 	conn, err := GetGRPCConnection(address)
// 	if err != nil {
...
// 	return metabftOp.NewmetabftOperatorClient(conn), nil
// }
