...
import (
	...
	cmdHelper "github.com/DAO-Metaplayer/metachain/command/helper"
	...
	"github.com/DAO-Metaplayer/metachain/consensus/mbft/contractsapi/artifact"
...
var (
	...
	metadataPopulatorMap = map[string]func(*mbft.RootchainConfig, types.Address){
		stateSenderName: func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.StateSenderAddress = addr
		},
		getProxyNameForImpl(checkpointManagerName): func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.CheckpointManagerAddress = addr
		},
		getProxyNameForImpl(blsName): func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.BLSAddress = addr
		},
		getProxyNameForImpl(bn256G2Name): func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.BN256G2Address = addr
		},
		getProxyNameForImpl(exitHelperName): func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ExitHelperAddress = addr
		},
		getProxyNameForImpl(rootERC20PredicateName): func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.RootERC20PredicateAddress = addr
		},
		getProxyNameForImpl(childERC20MintablePredicateName): func(
			rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ChildMintableERC20PredicateAddress = addr
		},
		rootERC20Name: func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.RootNativeERC20Address = addr
		},
		erc20TemplateName: func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ChildERC20Address = addr
		},
		getProxyNameForImpl(rootERC721PredicateName): func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
		...
		erc721TemplateName: func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ChildERC721Address = addr
		},
		getProxyNameForImpl(rootERC1155PredicateName): func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
		...
		erc1155TemplateName: func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
			rootchainConfig.ChildERC1155Address = addr
		},
		getProxyNameForImpl(customSupernetManagerName): func(rootchainConfig *mbft.RootchainConfig, addr types.Address) {
...
type deploymentResultInfo struct {
	RootchainCfg   *mbft.RootchainConfig
	SupernetID     int64
...
func runCommand(cmd *cobra.Command, _ []string) {
	...
	chainConfig.Params.Engine[mbft.ConsensusName] = consensusCfg
...
func deployContracts(outputter command.OutputFormatter, client *jsonrpc.Client, chainID int64,
	...
	rootchainConfig := &mbft.RootchainConfig{
...
func populateExistingTokenAddr(eth *jsonrpc.Eth, tokenAddr, tokenName string,
	rootchainCfg *mbft.RootchainConfig) error {
...
func registerChainOnStakeManager(txRelayer txrelayer.TxRelayer,
	rootchainCfg *mbft.RootchainConfig, deployerKey ethgo.Key) (int64, error) {
