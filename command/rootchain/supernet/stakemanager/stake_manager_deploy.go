...
func setFlags(cmd *cobra.Command) {
	...
	cmd.Flags().StringVar(
		&params.privateKey,
		mbftsecrets.PrivateKeyFlag,
		"",
		mbftsecrets.PrivateKeyFlagDesc,
	)
	...
	cmd.MarkFlagsMutuallyExclusive(mbftsecrets.PrivateKeyFlag, mbftsecrets.AccountConfigFlag)
	cmd.MarkFlagsMutuallyExclusive(mbftsecrets.PrivateKeyFlag, mbftsecrets.AccountDirFlag)
	cmd.MarkFlagsMutuallyExclusive(rootHelper.TestModeFlag, mbftsecrets.PrivateKeyFlag)
	cmd.MarkFlagsMutuallyExclusive(rootHelper.TestModeFlag, mbftsecrets.AccountConfigFlag)
	cmd.MarkFlagsMutuallyExclusive(rootHelper.TestModeFlag, mbftsecrets.AccountDirFlag)
...
func runCommand(cmd *cobra.Command, _ []string) error {
	...
	chainConfig.Params.Engine[mbft.ConsensusName] = consensusConfig
