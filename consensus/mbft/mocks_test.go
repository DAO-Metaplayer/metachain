...
var _ mbftBackend = (*mbftBackendMock)(nil)

type mbftBackendMock struct {
	mock.Mock
}

// GetValidators retrieves validator set for the given block
func (p *mbftBackendMock) GetValidators(blockNumber uint64, parents []*types.Header) (validator.AccountSet, error) {
	...
	panic("mbftBackendMock.GetValidators doesn't support such combination of arguments") //nolint:gocritic
}
