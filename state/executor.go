...
import (
	...
	"github.com/DAO-Metaplayer/metachain/state/runtime/precompiled"
	"github.com/DAO-Metaplayer/metachain/state/runtime/tracer"
	"github.com/DAO-Metaplayer/metachain/state/runtime/vm"
...
const (
	...
	TxGas                 uint64 = 0       // Per transaction not creating a contract
	TxGasContractCreation uint64 = 2100000 // Per transaction that creates a contract
)
